    ...
    def getImageFile(self):
        if self.imageUrl:
            ...
            try:
                ...
                return None
            path = "F:\\UCL 巴莱\\学习\\RC11\\软件学习\\Python\\Wanting-Ding_RC11_Python\\assignment1\\ArtImages\\"+self.artist+"_"+self.id+".jpg"
            self.imagePath = path
            im.save(path, "JPEG")


artPieces = []
with open("F:\\UCL 巴莱\\学习\\RC11\\软件学习\\Python\\Wanting-Ding_RC11_Python\\assignment1\\CSVFiles\\Artworks.csv", encoding='utf-8-sig')as artFile:
